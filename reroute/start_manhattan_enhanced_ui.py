#!/usr/bin/env python3
"""
Start Manhattan Bus Dispatch System - Enhanced UI
Modern UI with MapLibre GL JS, stop icons, and route filtering
"""
...
def start_manhattan_enhanced_ui_server():
    """Start the Manhattan bus dispatch server with enhanced UI"""
    print("🚌 Starting Manhattan Bus Dispatch Server with Enhanced UI...")
    ...
    try:
        ...
        # Start the server
        server_script = "server/fastapi_manhattan_enhanced_ui.py"
        
        print(f"✓ Server: http://localhost:8000")
        print(f"✓ Enhanced UI: MapLibre GL JS with stop icons")
        print(f"✓ Real-time Tracking: Active")
        print(f"✓ Route Filtering: Active")
        print(f"✓ Stop Icons: Smaller, cleaner design")
...
def main():
    ...
    # Start server
    print("\n🚌 STARTING ENHANCED UI SERVER")
    print("=" * 30)
    if not start_manhattan_enhanced_ui_server():
        print("✗ Failed to start server")
        return False
    
    print("✅ Manhattan system with enhanced UI started successfully!")
    return True
