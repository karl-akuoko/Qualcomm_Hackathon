#!/usr/bin/env python3
"""
Start Manhattan Bus Dispatch System - Grid Routes
...
def start_manhattan_grid_routes_server():
    """Start the Manhattan bus dispatch server with grid routes"""
    print("🚌 Starting Manhattan Bus Dispatch Server with Grid Routes...")
    ...
    try:
        ...
        # Start the server
        server_script = "server/fastapi_manhattan_grid_routes.py"
        
        print(f"✓ Server: http://localhost:8000")
        print(f"✓ Grid Routes: Buses follow NYC street grid")
        print(f"✓ Realistic Movement: Avenues and streets")
        print(f"✓ Route Visualization: Grid paths shown on map")
...
def main():
    ...
    # Start server
    print("\n🚌 STARTING GRID ROUTES SERVER")
    print("=" * 30)
    if not start_manhattan_grid_routes_server():
        print("✗ Failed to start server")
        return False
    
    print("✅ Manhattan system with grid routes started successfully!")
    return True
