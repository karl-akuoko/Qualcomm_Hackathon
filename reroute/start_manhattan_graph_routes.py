#!/usr/bin/env python3
"""
Start Manhattan Bus Dispatch System - Graph Routes
...
def start_manhattan_graph_routes_server():
    """Start the Manhattan bus dispatch server with graph routes"""
    print("🚌 Starting Manhattan Bus Dispatch Server with Graph Routes...")
    ...
    try:
        ...
        # Start the server
        server_script = "server/fastapi_manhattan_graph_routes.py"
        
        print(f"✓ Server: http://localhost:8000")
        print(f"✓ Graph Routes: Shortest path routing")
        print(f"✓ Realistic Movement: Actual bus stops & routes")
        print(f"✓ Route Visualization: Graph paths shown on map")
...
def main():
    ...
    # Start server
    print("\n🚌 STARTING GRAPH ROUTES SERVER")
    print("=" * 30)
    if not start_manhattan_graph_routes_server():
        print("✗ Failed to start server")
        return False
    
    print("✅ Manhattan system with graph routes started successfully!")
    return True
