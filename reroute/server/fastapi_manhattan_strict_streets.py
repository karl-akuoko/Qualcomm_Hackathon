#!/usr/bin/env python3
"""
Manhattan Bus Dispatch Server - Strict Street Movement
Buses can ONLY move along actual Manhattan streets (no diagonal movement)
"""
...
app = FastAPI(title="Manhattan Bus Dispatch - Strict Streets")
...
class StrictManhattanSystem:
    def __init__(self):
        self.stops: Dict[str, BusStop] = {}
        self.buses: Dict[int, Bus] = {}
        self.routes: Dict[str, Dict] = {}
        self.simulation_time = 0
        self.passenger_generation_rate = 0.2
        self.max_passengers_at_stop = 15
        self._load_gtfs_data()
        self._initialize_buses()
    
    def _load_gtfs_data(self):
        """Load GTFS data and map to strict street grid"""
        print("🗽 Loading GTFS Data for Strict Street System...")
        
        gtfs_path = os.path.join(os.path.dirname(__file__), '..', 'UI_data', 'gtfs_m')
        
        try:
            stops_df = pd.read_csv(os.path.join(gtfs_path, 'stops.txt'), nrows=200)
            ...
            # Use first 30 stops for simplicity
    ...
    def _initialize_buses(self):
        """Initialize buses on strict street grid"""
        bus_id = 0
        ...
        print(f"✅ Initialized {len(self.buses)} buses on strict street grid")
    
    def step(self):
        """Step the simulation with strict street movement"""
...
async def startup_event():
    ...
    print("🗽 Starting Strict Manhattan Street System...")
    manhattan_system = StrictManhattanSystem()
    print("✅ Strict Manhattan street system initialized!")
...
<head>
  ...
  <title>Manhattan Bus Dispatch - Strict Streets</title>
...
<div id="app">
  <div id="sidebar">
    <div>
      ...
      <div class="muted">Strict Street Movement</div>
    </div>
    <div class="panel">
...
<script>
  ...
  function connectWebSocket() {
    ...
    ws.onopen = () => {
      console.log('Connected to strict street system');
      isConnected = true;
