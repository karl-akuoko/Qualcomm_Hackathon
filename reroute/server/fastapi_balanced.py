...
app = FastAPI(title="Bus Dispatch RL - Balanced", version="1.0.0")
...
async def root():
    """Serve the dashboard with balanced system"""
    dashboard_html = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Bus Dispatch RL - Balanced</title>
        <style>
    ...
    <body>
        <div class="container mobile-optimized">
            <div class="header">
                <h1>🚌 Bus Dispatch RL - Balanced System</h1>
                ...
                <div style="margin-top: 10px; font-size: 12px; color: #6b7280;">
                    ✅ Balanced: 12 buses for 20 stops | ✅ Passenger drop-off fixed | ✅ Efficient routing
                </div>
            </div>
            ...
            <div class="card">
                <h3>Manhattan Grid Simulation - Balanced System</h3>
...
async def startup_event():
    """Initialize simulation environment with balanced system"""
    global simulation_env
    
    print("Initializing Bus Dispatch System with Balanced Configuration...")
    
    # Initialize environment with better balance
    simulation_env = BusDispatchEnv(
        grid_size=(20, 20),
        num_stops=20,  # Reduced from 32 to 20
        num_buses=12,  # Increased from 6 to 12
        time_step=1.0,
    ...
    print("Bus Dispatch System with Balanced Configuration initialized successfully!")
    print(f"✅ Balanced: {simulation_env.num_buses} buses for {simulation_env.num_stops} stops")
    print(f"✅ Ratio: {simulation_env.num_buses / simulation_env.num_stops:.2f} buses per stop")

async def simulation_loop():
    """Simulation loop with balanced system"""
...
async def shutdown_event():
    ...
    global is_running
    is_running = False
    print("Shutting down Bus Dispatch System with Balanced Configuration...")
