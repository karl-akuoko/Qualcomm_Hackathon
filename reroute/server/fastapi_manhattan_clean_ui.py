#!/usr/bin/env python3
"""
Manhattan Bus Dispatch System - Clean UI
Modern UI with MapLibre GL JS and real-time bus tracking
"""
...
class ManhattanBusDispatchSystem:
    """Manhattan bus dispatch system with clean UI"""
...
# FastAPI App
app = FastAPI(title="Manhattan Bus Dispatch System - Clean UI")
...
async def startup_event():
    ...
    print("🗽 Initializing Manhattan Bus Dispatch System with Clean UI...")
    manhattan_system = ManhattanBusDispatchSystem()
    print("✅ Manhattan system with clean UI initialized successfully!")
...
async def get_manhattan_dashboard():
    """Serve the Manhattan bus dispatch dashboard with clean UI"""
    return """
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Manhattan Bus Dispatch — Clean UI</title>
...
<div id="app">
  <div id="sidebar">
    <div>
      ...
      <div class="muted">Real-time bus tracking with RL dispatch</div>
    </div>
    ...
    <div class="panel">
      <div><span class="chip">Live tracking</span> <span class="chip">RL dispatch</span></div>
      <div style="margin-top:8px; display:flex; gap:8px;">
...
<div class="legend">Bus Stops • Click for details</div>
...
if __name__ == "__main__":
    print("🗽 STARTING MANHATTAN BUS DISPATCH SYSTEM - CLEAN UI")
    print("=" * 60)
    print("🗺️ MapLibre GL JS Map")
