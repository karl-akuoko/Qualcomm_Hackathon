...
app = FastAPI(title="Bus Dispatch RL - Working", version="1.0.0")
...
async def root():
    """Serve the dashboard with working passenger boarding"""
    dashboard_html = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Bus Dispatch RL - Working</title>
        <style>
    ...
    <body>
        <div class="container mobile-optimized">
            ...
            <div class="card">
                <h3>Manhattan Grid Simulation - Working</h3>
...
async def startup_event():
    """Initialize simulation environment with working data structures"""
    global simulation_env
    
    print("Initializing Bus Dispatch System with Working Data Structures...")
    ...
    print("Bus Dispatch System with Working Data Structures initialized successfully!")

async def simulation_loop():
    """Simulation loop with working data structures"""
...
async def shutdown_event():
    ...
    global is_running
    is_running = False
    print("Shutting down Bus Dispatch System with Working Data Structures...")
