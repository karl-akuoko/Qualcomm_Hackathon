...
app = FastAPI(title="Bus Dispatch RL Clean API", version="1.0.0")
...
async def root():
    ...
    <head>
        ...
        <title>Bus Dispatch RL - Clean</title>
        <style>
    ...
    <body>
        <div class="container mobile-optimized">
            <div class="header">
                <h1>🚌 Bus Dispatch RL - Clean Interface</h1>
            ...
            function updateMap() {
                ...
                if (systemState.stops) {
                    systemState.stops.forEach(stop => {
                        ...
                        stopElement.style.left = (stop.x * (500 / gridSize) - 10) + 'px';
                        stopElement.style.top = (stop.y * (500 / gridSize) - 10) + 'px';
                ...
                if (systemState.buses) {
                    systemState.buses.forEach(bus => {
                        ...
                        busElement.style.left = (bus.x * (500 / gridSize) - 12) + 'px';
                        busElement.style.top = (bus.y * (500 / gridSize) - 12) + 'px';
...
async def startup_event():
    """Initialize simulation environment with trained model"""
    global simulation_env
    
    print("Initializing Clean Bus Dispatch System...")
    ...
    print("Clean system initialized successfully!")

async def simulation_loop():
    """Clean simulation loop with trained model support"""
    ...
    while is_running:
        try:
            ...
            if current_mode == "rl" and trained_model is not None:
                ...
                # Static mode or no trained model
...
async def shutdown_event():
    ...
    global is_running
    is_running = False
    print("Shutting down Clean Bus Dispatch System...")
