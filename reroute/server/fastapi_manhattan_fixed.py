#!/usr/bin/env python3
"""
Manhattan Bus Dispatch System - Fixed Version
Realistic bus dispatch simulation with proper movement and NYC map
"""
...
class ManhattanBusDispatchSystem:
    """Fixed Manhattan bus dispatch system with proper movement"""
    ...
    def _initialize_system(self):
        """Initialize the Manhattan bus system with proper spacing"""
        print("🚌 Initializing Manhattan bus system...")
        
        # Create buses for each route with better spacing
        self.buses = {}
        bus_id = 0
        
        for route_id, route in self.routes.items():
            # Create 2-3 buses per route with staggered starts
            num_buses = 2 if "SBS" in route_id else 3
            
            for i in range(num_buses):
                # Stagger bus starting positions
                start_stop_index = i * (len(route.stops) // num_buses)
                start_stop_id = route.stops[start_stop_index] if route.stops else route.stops[0]
                start_stop = self.stops[start_stop_id]
                ...
                bus = {
                    ...
                    "next_stop_index": start_stop_index,
                    "x": start_stop.x,
                    "y": start_stop.y,
                    "load": 0,
                    "capacity": 40,
                    ...
                    "status": "moving",
                    "passengers": [],
                    "stuck_counter": 0,  # Track if bus is stuck
                    "last_position": (start_stop.x, start_stop.y)
                }
    ...
    def _load_rl_model(self):
        ...
        try:
            with open("manhattan_rl_model.json", 'r') as f:
                model_data = json.load(f)
            print("✅ RL model loaded successfully!")
        except:
            print("⚠️ No RL model found, using intelligent routing")
    ...
    def generate_passengers(self):
        ...
        for stop_id, stop in self.stops.items():
            ...
            # Generate passengers based on demand (reduced rate to prevent overcrowding)
            if random.random() < demand * 0.05:  # Reduced from 0.1 to 0.05
    ...
    def _process_bus_arrival(self, bus_id: int, stop_id: str):
        ...
        # Pick up passengers (limit to prevent overcrowding)
    ...
    def step(self):
        ...
        # Generate new passengers (reduced rate)
...
# FastAPI App
app = FastAPI(title="Manhattan Bus Dispatch System - Fixed")
...
async def startup_event():
    ...
    print("🗽 Initializing Fixed Manhattan Bus Dispatch System...")
    manhattan_system = ManhattanBusDispatchSystem()
    print("✅ Fixed Manhattan system initialized successfully!")

@app.on_event("shutdown")
async def shutdown_event():
    """Cleanup on shutdown"""
    print("🛑 Shutting down Fixed Manhattan Bus Dispatch System...")

@app.get("/", response_class=HTMLResponse)
async def get_manhattan_dashboard():
    """Serve the Manhattan bus dispatch dashboard with NYC map"""
    return """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Manhattan Bus Dispatch System - NYC Map</title>
        ...
        <header class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">🗽 Manhattan Bus Dispatch - NYC Map</h1>
                        <p class="text-sm text-gray-600">Real NYC Streets • MTA Routes • Dynamic Dispatch</p>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-sm border p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">🗺️ Manhattan NYC Map</h3>
                        <div class="relative">
                            ...
                            <div class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-sm">
                                <h4 class="font-semibold text-sm text-gray-900 mb-2">NYC Landmarks</h4>
                                <div class="space-y-1 text-xs">
                                    <div class="flex items-center space-x-2">
                                        <div class="w-3 h-3 bg-red-500 rounded-full"></div>
...
if __name__ == "__main__":
    print("🗽 STARTING FIXED MANHATTAN BUS DISPATCH SYSTEM")
    print("=" * 50)
