#!/usr/bin/env python3
"""
Start Manhattan Bus Dispatch System - Working Version
...
def start_manhattan_server():
    ...
    try:
        ...
        # Start the server
        server_script = "server/fastapi_manhattan_simple.py"
...
def main():
    ...
    print("🗽 MANHATTAN BUS DISPATCH SYSTEM - WORKING VERSION")
    print("=" * 50)
